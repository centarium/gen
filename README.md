...
[![License](https://img.shields.io/badge/License-Apache%203.0-blue.svg)](https://opensource.org/licenses/Apache-3.0) [![GoDoc](https://godoc.org/github.com/centarium/gen?status.png)](http://godoc.org/github.com/centarium/gen)  [![travis](https://travis-ci.org/smallnest/gen.svg?branch=master)](https://travis-ci.org/smallnest/gen) [![Go Report Card](https://goreportcard.com/badge/github.com/centarium/gen)](https://goreportcard.com/report/github.com/centarium/gen)
...
## go version < 1.17
$ go get -u github.com/centarium/gen

## go version == 1.17
$ go install github.com/centarium/gen@latest

## download sample sqlite database
$ wget https://github.com/centarium/gen/raw/master/example/sample.db
...
See more contributors: [contributors](https://github.com/centarium/gen/graphs/contributors)
